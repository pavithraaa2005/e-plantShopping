...
function ProductList() {
  ...
  // Calculate total items for the navbar dynamically
  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Jasmine", image: "https://images.unsplash.com/photo-1592873117462-23c58852e693?q=80&w=1000&auto=format&fit=crop", description: "Sweet fragrance, promotes relaxation.", cost: "$18" },
        ...
        { name: "Lemon Balm", image: "https://cdn.pixabay.com/photo/2019/09/16/04/31/lemon-balm-4480134_1280.jpg", description: "Citrusy scent, relieves stress and anxiety.", cost: "$14" },
        { name: "Hyacinth", image: "https://cdn.pixabay.com/photo/2019/04/07/20/21/hyacinth-4110726_1280.jpg", description: "Hyacinth is a beautiful flowering plant known for its fragrant.", cost: "$22" }
      ]
    },
    {
      ...
      plants: [
        ...
        { name: "Geraniums", image: "https://cdn.pixabay.com/photo/2012/04/26/21/51/flowerpot-43270_1280.jpg", description: "Known for their insect-repelling properties while adding pleasant scent.", cost: "$20" },
        { name: "Basil", image: "https://cdn.pixabay.com/photo/2016/07/24/20/48/basil-1539181_1280.jpg", description: "Repels flies and mosquitoes, also used in cooking.", cost: "$9" },
        { name: "Lavender", image: "https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80&w=1000&auto=format&fit=crop", description: "Calming scent, used in aromatherapy.", cost: "$20" },
  ...
  // Dispatches addItem to Redux and updates local button state
            ...
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <h1 className='cart'>
                <div style={{position:'relative'}}>
                    {/* Dynamic total quantity display */}
                    <span className='cart_quantity_count' style={{position:'absolute', top:'-10px', right:'-10px', backgroundColor:'red', borderRadius:'50%', padding:'2px 8px', fontSize:'16px'}}>{totalQuantity}</span>
